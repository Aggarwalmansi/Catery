      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-wrap justify-between">
          ...
          <a href="/#about" className="text-gray-400 hover:text-white">
            About Us
              ...
              <li>
                <Link href="/comingsoon" className="text-gray-400 hover:text-white">
                  FAQs
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4">
            <a href="/comingsoon" className="text-gray-500 hover:text-white"><Twitter /></a>
            <a href="/comingsoon" className="text-gray-500 hover:text-white"><Instagram /></a>
            <a href="/comingsoon" className="text-gray-500 hover:text-white"><Linkedin /></a>
          </div>
        </div>
      </div>
    </footer>
